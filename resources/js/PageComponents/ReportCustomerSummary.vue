        ...
        <div v-if="report_data != null && Object.keys(report_data).length > 0">
            <div class="grid grid-cols-6 gap-x-4 mb-4">
                ...
                <div class="col-span-4 text-center">
                    <h3 class="text-2xl font-bold mb-0">Customer Summary Report</h3>
            ...
            <div class="px-6 py-4 my-4 border rounded-3xl shadow-sm break-inside-avoid" v-for="(customer_data, customer_id) in report_data" :key="customer_id">
                ...
                <vue-good-table
                    ...
                    :rows="[{
                        children: customer_data['timesheet_entries']
                    }]"
                    :search-options="{
                        enabled: false,
                    }"
                ...
                <vue-good-table
                    ...
                    :rows="customer_data['timesheet_entry_items']"
                    :search-options="{
                        enabled: false,
                    }"
                    :sort-options="{
...
export default {
    ...
    props: ['customer_id', 'from_date', 'to_date'],
    ...
    created () {
        ...
        // Get the report data
        axios.get('/customer_summary_report', {
            params: {
    ...
    computed: {
        current_url () {
            return '/reports?report=customer_summary&customer_id=' + this.customer_id + '&from_date=' + this.from_date + '&to_date=' + this.to_date + '&onload=true';
        },
