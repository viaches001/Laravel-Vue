...
<div>
    <timesheet-entry-item v-for="(item, index) in object.items" :key="index" :object="object" :items="items" :item="item" :index="index" :view_only="view_only"></timesheet-entry-item>
...
<script>
    ...
    import TimesheetEntryItem from '@/PageComponents/TimesheetEntryItem';
